      ...
      <form onSubmit={handleSubmit} className="row g-4">
        <div className="col-md-4">
          ...
          <img
            ...
            src={formData.avatar || currentUser.avatar}
            alt="profile"
            className="rounded-circle h-24 w-24 object-cover cursor-pointer mx-auto d-block mt-2"
          />
        ...
        <div className="col-md-8">
          ...
          <Link className="btn btn-success mt-2" to={"/create-listing"}>
            Create Listing
          </Link>
        </div>
      </form>
      <div className="row mt-4">
        ...
        <div className="col-md-6">
          <span
            ...
            className="text-danger cursor-pointer float-end"
          >
            Sign out
          </span>
        </div>
